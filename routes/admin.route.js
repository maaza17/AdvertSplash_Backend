...
router.get('/logout', async (req, res) => {
    return res.status(200).cookie('auth_token_adm', "null", { maxAge: "0", httpOnly: true, secure: process.env.NODE_ENV == 'production', sameSite: "none" }).json({
        message: "Logout successful! 2",
    })
