...
router.get('/logout', async (req, res) => {
    return res.status(200).clearCookie('auth_token_adm', { domain: "adsplashserver.vercel.app", path: "/api/admin/login", httpOnly: true, secure: process.env.NODE_ENV == 'production', sameSite: "none" }).json({
